...
// Load 32-bit integer into first element of vector, clear other elements
...
#elif defined(ARCH_ARM64)
	return vsetq_lane_u8(value, vec, Index & 0b00001111)
#else
	v128 ret = vec;
	ret._u8[Index & 0b00001111] = value;
	return ret;
#endif
}
...
#elif defined(ARCH_ARM64)
	return vsetq_lane_u16(value, vec, Index & 0b00000111)
#endif
}
...
#elif defined(ARCH_ARM64)
	return vsetq_lane_u32(value, vec, Index & 0b00000011)
#else
	v128 ret = vec;
	ret._u32[Index & 0b00000011] = value;
	return ret;
#endif
}
...
inline v128 gv_shuffle8(const v128& vec, const v128& ctrl)
{
	...
	v128 ret;
	for (u32 i = 0; i < 16; i++)
		ret._s8[i] = ctrl._s8[i] & 0b10000000 ? 0 : vec._s8[ctrl._s8[i] & 0b00001111];
	return ret;
#endif
}
